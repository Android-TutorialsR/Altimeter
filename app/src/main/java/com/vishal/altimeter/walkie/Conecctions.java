package com.vishal.altimeter.walkie;
 ...
 */
public class Conecctions extends ConnectionsActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_conecctions);
//        getSupportActionBar()
//                .setBackgroundDrawable(ContextCompat.getDrawable(this, R.drawable.actionBar));
    ...
    protected void onEndpointConnected(Endpoint endpoint) {
        Toast.makeText(this, "toast_connected" + endpoint.getName(), Toast.LENGTH_SHORT)
                .show();
    ...
    protected void onEndpointDisconnected(Endpoint endpoint) {
        Toast.makeText(
                this, "toast_disconnected" + endpoint.getName(), Toast.LENGTH_SHORT)
                .show();
        setState(State.SEARCHING);
    }
    ...
    private void updateTextView(TextView textView, State state) {
        switch (state) {
            case SEARCHING:
                ...
                textView.setText("status_searching");
                break;
            case CONNECTED:
